...
import com.example.dharampalsolanki.dharamgo.activity.CartDetails;
import com.example.dharampalsolanki.dharamgo.model.ItemData;

import java.util.ArrayList;

/**
 * Created by DharampalSolanki on 3/31/2017.
 */
...
*/
                            ...
                            if (cursor1.getCount()==0){
                                ...
                                Intent i = new Intent(context,CartDetails.class);
    ...
    public CartAdapter(ArrayList<ItemData> data, Context context, TextView cartItem) {
        this.dataSet = data;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
      ...
      holder.count.setText(dataSet.get(listPosition).getCount());
